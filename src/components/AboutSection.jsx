          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {personalData.interests.map((i, idx) => (
                  <span
                    key={idx}
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                {personalData.education.map((edu, i) => (
                  <div key={i} className="card p-5 hover:border-l-4 hover:border-primary-500 transition-all">
                    <h4 className="font-semibold">{edu.degree}</h4>
                    <p className="text-gray-600 dark:text-gray-400">{edu.institution}</p>
                    <div className="flex justify-between mt-2 text-sm">
                      <span className="text-gray-500 dark:text-gray-400">{edu.years}</span>
            ...
            <div>
              ...
              <div className="space-y-3">
                {personalData.certifications.map((c, i) => (
                  <div key={i} className="card p-4 flex justify-between items-center hover:bg-gray-50 dark:hover:bg-gray-700">
                    <div>
                      <h5 className="font-medium">{c.title}</h5>
                      <p className="text-sm text-gray-600 dark:text-gray-400">{c.issuer}</p>
                    </div>
                    <span className="text-sm text-gray-500 dark:text-gray-400">{c.date}</span>
                  </div>
                ))}
              </div>
            </div>
